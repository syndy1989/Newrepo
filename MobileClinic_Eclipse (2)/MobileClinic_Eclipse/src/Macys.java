	...
	public static void main (String[] args)
	{
	 ...
	 public void setUp() throws Exception {
	    ...
	    private void testCal(JSONObject application1) {
	    	try {
	    		MetricsCollector.start("U1_Macys", filePath1, packageName, launcherActivity, false);
	    	     Thread.sleep(15000);
	    	     CharlesPing.Startconnection();
	    	     CharlesPing.ClearCharles();
	    			...
	    			String s1 = "Click1";
	    			s1 = s1.replaceAll("[ \"']", "");
	    			IndivdualCollector.start("U1_Macys_01_ShopTab", filePath1, packageName);
	    			System.out.println("Click Shop tab:----------------------------------" + s1);
	    			Thread.sleep(30000);
	    			IndivdualCollector.stop(false, driver, "test");
	    			
	    			CharlesPing.Stopconnection();
	    			 Thread.sleep(5000);
	    		downlaodName = CharlesPing.downloadcsv(count, "U1_Macys_01_ShopTab");
	    			...
	    			String s2 = "Click2";
	    			s2 = s2.replaceAll("[ \"']", "");
	    			IndivdualCollector.start("U1_Macys_02_MenTab", filePath1, packageName);
	    			System.out.println("Click Men:----------------------------------" + s2);
	    			Thread.sleep(30000);
	    			IndivdualCollector.stop(false, driver, "test");
	    			CharlesPing.Stopconnection();
	    			 Thread.sleep(5000);
	    			downlaodName = CharlesPing.downloadcsv(count, "U1_Macys_02_MenTab");
	    			...
	    			String s3 = "Click3";
	    			s3 = s3.replaceAll("[ \"']", "");
	    			IndivdualCollector.start("U1_Macys_03_AllClothing", filePath1, packageName);
	    			System.out.println("Click All Clothihg:----------------------------------" + s3);
	    			Thread.sleep(15000);
	    			IndivdualCollector.stop(false, driver, "test");
	    			CharlesPing.Stopconnection();
	    			 Thread.sleep(5000);
	    			downlaodName = CharlesPing.downloadcsv(count, "U1_Macys_03_AllClothing");
	    			...
	    			String s4 = "Click4";
	    			s4 = s4.replaceAll("[ \"']", "");
	    			IndivdualCollector.start("U1_Macys_04_NewArrivals", filePath1, packageName);
	    			System.out.println("New Arrivals:----------------------------------" + s4);
	    			Thread.sleep(15000);
	    			IndivdualCollector.stop(false, driver, "test");
	    			CharlesPing.Stopconnection();
	    			 Thread.sleep(5000);
	    			downlaodName = CharlesPing.downloadcsv(count, "U1_Macys_04_NewArrivals");
	    			...
	    			String s5 = "Click5";
	    			s5 = s5.replaceAll("[ \"']", "");
	    			IndivdualCollector.start("U1_Macys_05_SelectProduct", filePath1, packageName);
	    			System.out.println("Select a Product : ---------------------------------" + s5);
	    			Thread.sleep(15000);
	    			IndivdualCollector.stop(false, driver, "test");
	    			CharlesPing.Stopconnection();
	    			 Thread.sleep(5000);
	    			downlaodName = CharlesPing.downloadcsv(count, "U1_Macys_05_SelectProduct");
	    			...
	    			String s6 = "Click6";
	    			s6 = s6.replaceAll("[ \"']", "");
	    			IndivdualCollector.start("U1_Macys_06_AddtoBag", filePath1, packageName);
	    			System.out.println("Add to bag:----------------------------------" + s6);
	    			Thread.sleep(15000);
	    			IndivdualCollector.stop(false, driver, "test");
	    			CharlesPing.Stopconnection();
	    			 Thread.sleep(5000);
	    			downlaodName = CharlesPing.downloadcsv(count, "U1_Macys_06_AddtoBag");
	    			...
	    			String s7 = "Click7";
	    			s7 = s7.replaceAll("[ \"']", "");
	    			IndivdualCollector.start("U1_Macys_08_ViewBag", filePath1, packageName);
	    			System.out.println("View Bag:----------------------------------" + s7);
	    			Thread.sleep(15000);
	    			IndivdualCollector.stop(false, driver, "test");
	    			CharlesPing.Stopconnection();
	    			 Thread.sleep(5000);
	    			downlaodName = CharlesPing.downloadcsv(count, "U1_Macys_08_ViewBag");
	    			...
	    			String s14 = "Click8";
	    			s14 = s14.replaceAll("[ \"']", "");
	    			IndivdualCollector.start("U1_Macys_08_BackToHome", filePath1, packageName);
	    			System.out.println("Back to Home:----------------------------------" + s14);
	    		    ...
	    		    fw2.close();
	    		     CharlesPing.Stopconnection();
	    		     Thread.sleep(5000);
	    		     downlaodName = CharlesPing.downloadcsv(count,"U1_Macys_08_BackToHome" );

	    	    CharlesPing.finalJson("U1_Macys");
