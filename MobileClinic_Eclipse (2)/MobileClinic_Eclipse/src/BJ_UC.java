...
public void setUp() throws Exception {
    ...
    try {
    MetricsCollector.start("U1_BJS", filePath1, packageName, launcherActivity, false);
         Thread.sleep(15000);
         CharlesPing.Startconnection();
         CharlesPing.ClearCharles();
    ...
    String s1 = "Click1";
    s1 = s1.replaceAll("[ \"']", "");
    IndivdualCollector.start("U1_BJS_01_ClickOnACategory", filePath1, packageName);
    System.out.println("ClickOnACategory:----------------------------------" + s1);
    Thread.sleep(15000);
    IndivdualCollector.stop(false, driver, "test");
    
    CharlesPing.Stopconnection();
    Thread.sleep(5000);
    downlaodName = CharlesPing.downloadcsv(count, "U1_BJS_01_ClickOnACategory");
    ...
    String s2 = "Click2";
    s2 = s2.replaceAll("[ \"']", "");
    IndivdualCollector.start("U1_BJS_02_ClickOnAProduct", filePath1, packageName);
    System.out.println("ClickOnAProduct:----------------------------------" + s2);
    Thread.sleep(15000);
    IndivdualCollector.stop(false, driver, "test");
    CharlesPing.Stopconnection();
    Thread.sleep(5000);
    downlaodName = CharlesPing.downloadcsv(count, "U1_BJS_02_ClickOnAProduct");
    ...
    String s3 = "Click3";
    s3 = s3.replaceAll("[ \"']", "");
    IndivdualCollector.start("U1_BJS_03_AddItemtoCart", filePath1, packageName);
    System.out.println("AddItemtoCart:----------------------------------" + s3);
    Thread.sleep(15000);
    IndivdualCollector.stop(false, driver, "test");
    CharlesPing.Stopconnection();
    Thread.sleep(5000);
    downlaodName = CharlesPing.downloadcsv(count, "U1_BJS_03_AddItemtoCart");
    ...
    String s4 = "Click4";
    s4 = s4.replaceAll("[ \"']", "");
    IndivdualCollector.start("U1_BJS_04_SearchForProduct", filePath1, packageName);
    System.out.println("SearchForProduct:----------------------------------" + s4);
    Thread.sleep(15000);
    IndivdualCollector.stop(false, driver, "test");
    CharlesPing.Stopconnection();
    Thread.sleep(5000);
    downlaodName = CharlesPing.downloadcsv(count, "U1_BJS_04_SearchForProduct");
    ...
    String s5 = "Click5";
    s5 = s5.replaceAll("[ \"']", "");
    IndivdualCollector.start("U1_BJS_05_ViewCart", filePath1, packageName);
    System.out.println("ViewCart: ---------------------------------" + s5);
    Thread.sleep(15000);
    IndivdualCollector.stop(false, driver, "test");
    CharlesPing.Stopconnection();
    Thread.sleep(5000);
    downlaodName = CharlesPing.downloadcsv(count, "U1_BJS_05_ViewCart");
    ...
    String s6 = "Click6";
    s6 = s6.replaceAll("[ \"']", "");
    IndivdualCollector.start("U1_BJS_06_RemoveItemFromCart", filePath1, packageName);
    System.out.println("RemoveItemFromCart:----------------------------------" + s6);
    Thread.sleep(15000);
    Thread.sleep(5000);
    ...
    JSONArray individual=IndivdualCollector.stop(true, driver, "test");
        ...
        fw2.close();
         CharlesPing.Stopconnection();
         Thread.sleep(5000);
    downlaodName = CharlesPing.downloadcsv(count, "U1_BJS_06_RemoveItemFromCart");
    ...
    String s14 = "Click8";
    s14 = s14.replaceAll("[ \"']", "");
    IndivdualCollector.start("U1_CompShare_07_LogOut", filePath1, packageName);
    ...
    JSONArray individual=IndivdualCollector.stop(true, driver, "test");
        ...
        fw2.close();
         CharlesPing.Stopconnection();
         Thread.sleep(5000);
         downlaodName = CharlesPing.downloadcsv(count,"U1_CompShare_07_LogOut" );*/

        CharlesPing.finalJson("U1_BJS");
        JSONObject U1_BJS=MetricsCollector.stop();

JSONObject hits1 = new JSONObject();
hits1.put("_source", U1_BJS);
root.add(hits1);
